...
const containsAnd = (arr) => {
  // Solution code here...
  return arr.filter(String => String.includes("and"));/* includes return true or false */ 
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  return arr.filter((obj) =>{ if(obj.baseStat > minBaseStat) {
    return true;
  }});
};
/* ------------------------------------------------------------------------------------------------
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let newArr= arr.filter((obj) =>{ if(obj.baseStat > minBaseStat) {
    return true;
  }});
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  return arr.filter((obj) =>{ if(!obj.children) {
    return true;
  }});
};
...
const evenOddNumericValues = (arr) => {
  ...
  return newArr.map(num=>{  if(num % 2 == 0){
    return 'even';
  }
  else if(num % 2 !== 0){
    return 'odd';
