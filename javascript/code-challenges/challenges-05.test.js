...
const reversedString = (str) => {/*['a','b','d']*/
  // Solution code here...
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  return arr.reduce((a,b)=>{
    if (typeof b.children == "object") {/**if( b.children ) */
...
const extractStat = (statName, arr) => {
  // Solution code here...
   return arr.reduce((a, b) => (a = statName === b.stat.name ? b : a), "");
};
...
const extractChildren = (arr) => arr.filter((e) => e.name.includes("a")).reduce((a, b) => (b.children ? [...a, ...b.children] : [...a]), []);
